    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-24">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-20 left-20 w-32 h-32 border-l border-t border-slate-200" />
          <div className="absolute bottom-20 right-20 w-32 h-32 border-r border-b border-slate-200" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="relative">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-50 border border-slate-200 text-accent-orange mb-8 backdrop-blur-sm shadow-sm">
            ...
            <div className="relative inline-block mb-6">
              <motion.h1 
                className="text-5xl md:text-7xl font-extrabold tracking-tight pb-2 text-slate-900"
      ...
      <SectionWrapper>
        <div className="flex justify-between items-end mb-12 flex-wrap gap-4">
          <motion.div variants={fadeIn}>
            <h2 className="text-4xl font-bold mb-2 text-slate-900">Featured Prints</h2>
            <p className="text-slate-600">Our best-selling ready-to-ship models.</p>
          </motion.div>
          <motion.div variants={fadeIn}>
      ...
      <SectionWrapper className="bg-[rgb(var(--secondary-bg))]">
        <motion.div variants={fadeIn} className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-slate-900">Why Tork3D</h2>
          <p className="text-slate-600 max-w-2xl mx-auto">We combine top-tier technology with engineering expertise.</p>
        </motion.div>
          ...
          {FEATURES.map((feature, i) => {
            ...
            return (
              <motion.div key={feature.title} variants={fadeIn} className="glass-card p-8 group">
                <div className="w-14 h-14 rounded-xl bg-slate-50 flex items-center justify-center mb-6 group-hover:bg-accent-orange/10 transition-colors duration-300">
      ...
      <SectionWrapper>
        <motion.div variants={fadeIn} className="relative rounded-3xl overflow-hidden glass-card p-12 md:p-20 text-center">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Ready to print your idea?</h2>
